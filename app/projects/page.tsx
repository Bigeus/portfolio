...
export default function ProjectsPage() {
  ...
  return (
    ...
    <div className="space-y-6">
      <div className="inline-flex items-center gap-3 animate-pulse text-muted-foreground">
        <RocketIcon className="w-6 h-6" />
        <span className="uppercase tracking-wide text-sm">Coming Soon</span>
      </div>

      <h1 className="text-4xl md:text-6xl font-playfair font-bold">
        Em breve: Projetos incríveis
      </h1>

      <p className="text-muted-foreground text-lg max-w-xl mx-auto">
        Estou trabalhando em algo especial! Esta seção está sendo construída com carinho para apresentar meus projetos mais recentes.
      </p>
